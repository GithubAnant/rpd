                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {!isExpanded && paper.abstract.length > 200 && (
                            <button
                                onClick={handleExpand}
                                className="text-[#1d9bf0] text-[15px] mt-1 hover:underline"
                            >
                                Show more
                            </button>
                        )}
                        ...
                        <div className="flex items-center justify-between mt-3 max-w-[425px]">
                            ...
                            <button
                                onClick={handleShare}
                                className="flex items-center gap-2 text-[#71767b] hover:text-[#1d9bf0] transition-colors group"
                            >
                                <div className="p-2 rounded-full group-hover:bg-[#1d9bf0]/10">
                                    <svg className="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <button
                                onClick={handleSave}
                                className={`flex items-center gap-2 transition-colors group ${isSaved ? 'text-[#1d9bf0]' : 'text-[#71767b] hover:text-[#1d9bf0]'}`}
                            >
                                <div className={`p-2 rounded-full ${isSaved ? 'bg-[#1d9bf0]/10' : 'group-hover:bg-[#1d9bf0]/10'}`}>
